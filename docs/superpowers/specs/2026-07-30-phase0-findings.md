...
| 4 | Plan A / Plan B | **Plan A**. 리슨 전용 탭 | 클릭 삼킴 불필요 |
...
우리가 개입하는 상태(1·2·3)에서 Dock은 아무 일도 하지 않는다. 따라서 **클릭을 삼킬 필요가 없고 `kCGEventTapOptionListenOnly`로 충분하다 (Plan A).** 우리의 비동기 최소화와 Dock의 복원이 경쟁하는 플립플롭도 발생하지 않는다.
